...
/**Player object represents the entity that is controlled by the player.
 * It is used by the player to deflect the ball.
 *
 */
public class Player implements Playable {
    ...
    /**Defines the color of the border of the player.
     *
     */
    ...
    /**Updates the position of the player based on the amount it should move.
     *
     */
    public void move(){
